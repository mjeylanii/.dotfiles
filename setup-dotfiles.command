...
# macOS Dotfiles Setup Command
# Double-click this file to set up your dotfiles from external drive
...
if [[ "$SCRIPT_DIR" == *"/Volumes/"* ]]; then
    ...
    print_status "Using external drive installation method"
    ...
    print_status "Using standard installation method"
